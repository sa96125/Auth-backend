...
let GraphQLFederationModule = GraphQLFederationModule_1 = class GraphQLFederationModule {
    ...
    static forRoot(options = {}) {
        options = (0, utils_2.mergeDefaults)(options);
        return {
        ...
        return {
            ...
            providers: [
                ...this.createAsyncProviders(options),
                {
                    ...
                    useValue: (0, utils_2.generateString)(),
                },
            ],
        };
    }
    ...
    static createAsyncOptionsProvider(options) {
        if (options.useFactory) {
            return {
                provide: graphql_constants_1.GRAPHQL_MODULE_OPTIONS,
                useFactory: async (...args) => (0, utils_2.mergeDefaults)(await options.useFactory(...args)),
                inject: options.inject || [],
            };
        }
        return {
            provide: graphql_constants_1.GRAPHQL_MODULE_OPTIONS,
            useFactory: async (optionsFactory) => (0, utils_2.mergeDefaults)(await optionsFactory.createGqlOptions()),
    ...
    async onModuleInit() {
        ...
        const mergedTypeDefs = (0, utils_2.extend)(typeDefs, this.options.typeDefs);
        ...
        if (this.options.definitions && this.options.definitions.path) {
            await this.graphqlFactory.generateDefinitions(printSubgraphSchema(apolloOptions.schema), this.options);
        }
    ...
    getNormalizedPath(apolloOptions) {
        ...
        const gqlOptionsPath = (0, utils_2.normalizeRoutePath)(apolloOptions.path);
        return useGlobalPrefix
            ? (0, utils_2.normalizeRoutePath)(prefix) + gqlOptionsPath
            : gqlOptionsPath;
    }
...
GraphQLFederationModule = GraphQLFederationModule_1 = (0, tslib_1.__decorate)([
    (0, common_1.Module)({
    ...
    (0, tslib_1.__metadata)("design:paramtypes", [core_1.HttpAdapterHost, Object, graphql_federation_factory_1.GraphQLFederationFactory,
        graphql_types_loader_1.GraphQLTypesLoader,
        graphql_factory_1.GraphQLFactory,
